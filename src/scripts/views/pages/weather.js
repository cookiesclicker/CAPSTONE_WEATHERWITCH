...
function getActivitiesBasedOnWeather(condition) {
  const outdoorActivities = ['Bersepeda', 'Piknik', 'Jogging', 'Bermain bola', 'Berenang'];
  const indoorActivities = ['Membaca buku', 'Menonton film', 'Mendengarkan musik', 'Bermain game', 'Memasak'];
